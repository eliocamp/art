diziet <- list(
  ...
  make_gallery = function(
    ...
    static <- paste0("~/GitHub/galleries/series-", name, "/docs") # <- hack until I have digests
    ...
    links <- paste0(
      ...
      '<a href="https://djnavarro.net/series-', name, '/', full, '/', full_images, '">',
      '<img width = 100% src="https://djnavarro.net/series-', name, '/',  preview, '/', preview_images, '">',
      '</a>',
      '</div>'
    )
